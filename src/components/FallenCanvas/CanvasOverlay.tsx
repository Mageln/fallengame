      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <Button
            size="s"
            mode="tertiary"
            style={{ ...btnBase, background: 'rgba(0,0,0,0.6)', color: '#fff', minWidth: 36 }}
            onClick={onGoProfile}
          >
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          <Button
            size="s"
            mode="tertiary"
            style={{ ...btnBase, background: 'rgba(0,0,0,0.6)', color: '#ffd700', minWidth: 36 }}
            onClick={onToggleMap}
          >
          ...
          <Button
            size="s"
            mode="tertiary"
            style={{ ...btnBase, background: 'rgba(0,0,0,0.6)', color: soundEnabled ? '#00ff88' : '#666', minWidth: 36 }}
