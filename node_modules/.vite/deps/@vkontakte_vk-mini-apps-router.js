...
import {
  Link
} from "./chunk-2HH243RF.js";
import "./chunk-SIGH45R4.js";
...
var _BridgeService = class _BridgeService {
  ...
  static enableNativeSwipeBack() {
    Promise.all([
      dist_default.send("VKWebAppSetSwipeSettings", { history: true }),
      dist_default.send("VKWebAppEnableSwipeBack")
  ...
  static disableNativeSwipeBack(consumerId) {
    ...
    if (instance.swipeBackConsumers.length === 0) {
      Promise.all([
        dist_default.send("VKWebAppSetSwipeSettings", { history: false }),
        dist_default.send("VKWebAppDisableSwipeBack")
      ]).catch(_BridgeService.handlePlatformError);
    }
  }
  static get instance() {
  ...
  (0, import_react3.useEffect)(() => {
    ...
    if (useBridge) {
      ...
      router.subscribe((state) => {
        ...
        dist_default.send("VKWebAppSetLocation", { location, replace_state: true });
      });
    }
